...
#[test]
fn relation_area_from_parsed_0() -> Result<(),Error> {
...
#[test]
fn relation_area_from_parsed_1() -> Result<(),Error> {
    let tags = vec![("type","multipolygon"),("natural", "water")];
    let mut nodes = HashMap::new();
    nodes.insert(100, (1.3, 1.2));
    nodes.insert(101, (1.3, 0.3));
    ...
    ways.insert(201, vec![102,103,100]);
    ways.insert(202, vec![104,105,106,104]);
...
#[test]
fn relation_area_from_parsed_2() -> Result<(),Error> {
    let tags = vec![("type","multipolygon"),("natural", "water")];
    let mut nodes = HashMap::new();
    nodes.insert(100, (1.3, 1.2));
    nodes.insert(101, (1.3, 0.3));
